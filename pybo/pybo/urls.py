...
from .views import base_views, question_views, answer_views, comment_views, vote_views, category_views
...
urlpatterns = [
    ...
    # Category
    path('category/create/', category_views.question_in_category, name='categoryCreate'),
]